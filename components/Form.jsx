  ...
  <main className="flex-grow flex items-center justify-center pt-32 pb-24 md:pt-40 md:pb-32 px-6 bg-gray-50/30">
    ...
    <div className="max-w-3xl w-full bg-gray-100 p-8 md:py-12 md:px-20 rounded-[2.5rem] md:rounded-[3rem] shadow-[0_10px_30px_rgba(0,0,0,0.05)] border-[1px] border-gray-200 transition-all">
      ...
      <div className="text-center mb-10">
        <h2 className="font-title text-2xl md:text-5xl text-black uppercase tracking-[0.25em] mb-4">
          Contacta con <span className="gold-text">nosotras</span>
        </h2>
        <div className="w-24 h-[1px] bg-gold mx-auto mb-6"></div>
        <p className="font-body text-gray-400 text-[7px] md:text-xl uppercase tracking-[0.3em] leading-relaxed">
      ...
      <form onSubmit={manejarEnvio} className="space-y-6 md:space-y-8">
        ...
        <div className="relative group">
          <label className="block font-body text-2xl max-md:text-lg uppercase tracking-[0.2em] text-gray-800 mb-2 group-focus-within:text-gold transition-colors">
            Nombre y Apellidos
          </label>
          <input
            type="text"
            name="nombre"
            required
            className="w-full text-2xl max-md:text-base bg-transparent border-b border-gray-200 py-2 outline-none focus:border-gold transition-all font-body text-gray-800 placeholder:text-gray-300"
        ...
        <div className="relative group">
          ...
          <textarea
            name="mensaje"
            rows="3"
            className="w-full text-2xl max-md:text-base bg-transparent border-b border-gray-200 py-2 outline-none focus:border-gold transition-all font-body text-gray-800 placeholder:text-gray-300 resize-none"
