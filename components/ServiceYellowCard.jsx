...
export default function ServiceYellowCard({ title, description, imageSrc, imageAlt, href }) {
  return (
    <section className="bg-white">
      ...
      <div className="gold-section py-[100px] px-8 flex flex-col items-center text-center">
        <h1 className="pt-15">
          {title}
        </h1>
      </div>
      ...
      <div className="gold-section py-[100px] flex flex-col items-center text-center">
        ...
        <div className="flex items-center justify-center gap-12 mt-10">
          ...
          <a
            ...
            className="bg-[#25D366] p-4 rounded-full hover:scale-110 transition-transform duration-300 shadow-xl"
