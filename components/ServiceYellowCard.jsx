...
export default function ServiceYellowCard({ title, description, imageSrc, imageAlt, href }) {
  return (
    <section className="bg-white">
      {/* Cabecera superior dorada */}
      <div className="gold-section py-[100px] max-md:py-14 px-6 flex flex-col items-center text-center">
      ...
      {/* Bloque inferior dorado */}
      <div className="gold-section py-[100px] max-md:py-14 px-6 flex flex-col items-center text-center">
        {/* Ajustamos el ancho máximo en móvil para que no sea tan estrecho */}
